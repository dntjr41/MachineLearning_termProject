  ...
  if docType == "query":
    ...
    for abstract in docs:
      ...
      for sentence in sentences:
        ...
        lamm_tokens = [wnl.lemmatize(token) for token in filtered_tokens]
        # stemming
        pst=PorterStemmer()
        stemmed_tokens=[pst.stem(token) for token in lamm_tokens]
        toks.append(stemmed_tokens)
      absToks.append(toks)
    return absToks
